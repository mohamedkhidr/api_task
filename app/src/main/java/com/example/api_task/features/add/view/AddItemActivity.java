package com.example.api_task.features.add.view;
...
import com.example.api_task.features.add.presenter.PresenterImpl;
...
public class AddItemActivity extends AppCompatActivity implements Validator.ValidationListener , AddItem {
    @NotEmpty
    @Length(max = 4 , min =1)
    ...
    public void onValidationSucceeded() {
        ...
        presenter.addItem(accessToken , itemId);
    }
